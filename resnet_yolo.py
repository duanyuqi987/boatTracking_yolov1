...
#        super(Bottleneck, self).__init__()
##        self.conv1 = nn.Conv2d(inplanes, planes, kernel_size=1, bias=False)
#        self.conv1 = SeparableConv2d(inplanes,planes,kernel_size=1,stride=1,padding=0,dilation=1,bias=False)
#        self.bn1 = nn.BatchNorm2d(planes)
##        self.conv2 = nn.Conv2d(planes, planes, kernel_size=3, stride=stride,
##                               padding=1, bias=False)
#        self.conv2 = SeparableConv2d(planes,planes,kernel_size=3,stride=stride,padding=1,dilation=1,bias=False)
#        self.bn2 = nn.BatchNorm2d(planes)
##        self.conv3 = nn.Conv2d(planes, planes * 4, kernel_size=1, bias=False)
#        self.conv3 = SeparableConv2d(planes,planes*4,kernel_size=1,stride=1,padding=0,dilation=1,bias=False)
#        self.bn3 = nn.BatchNorm2d(planes * 4)
#        self.relu = nn.ReLU(inplace=True)
#        self.downsample = downsample
#        self.stride = stride
...
#        self.conv_end = nn.Conv2d(256, 30, kernel_size=3, stride=1, padding=1, bias=False)
        self.conv_end = SeparableConv2d(256,30,kernel_size=3,padding=1)#使用可分离卷积
        self.bn_end = nn.BatchNorm2d(30)##权重w和偏重将被使用,归一化
